...
complete -c anchor -n "__fish_anchor_needs_command" -f -a "publish" -d 'Publishes a verified build to the Anchor registry'
...
complete -c anchor -n "__fish_anchor_using_subcommand init" -l package-manager -d 'Package Manager to use' -r -f -a "{npm\t'Use npm as the package manager',yarn\t'Use yarn as the package manager',pnpm\t'Use pnpm as the package manager'}"
...
complete -c anchor -n "__fish_anchor_using_subcommand init" -s s -l solidity -d 'Use Solidity instead of Rust'
...
complete -c anchor -n "__fish_anchor_using_subcommand verify" -s p -l program-name -r
complete -c anchor -n "__fish_anchor_using_subcommand verify" -s s -l solana-version -d 'Version of the Solana toolchain to use. For --verifiable builds only' -r
complete -c anchor -n "__fish_anchor_using_subcommand verify" -s d -l docker-image -d 'Docker image to use. For --verifiable builds only' -r
complete -c anchor -n "__fish_anchor_using_subcommand verify" -s b -l bootstrap -d 'Bootstrap docker image from scratch, installing all requirements for verifiable builds. Only works for debian-based images' -r -f -a "{none\t'',debian\t''}"
complete -c anchor -n "__fish_anchor_using_subcommand verify" -l arch -d 'Architecture to use when building the program' -r -f -a "{bpf\t'',sbf\t''}"
complete -c anchor -n "__fish_anchor_using_subcommand verify" -s e -l env -d 'Environment variables to pass into the docker container' -r
...
complete -c anchor -n "__fish_anchor_using_subcommand verify" -l skip-build -d 'Flag to skip building the program in the workspace, use this to save time when running verify and the program code is already built'
...
complete -c anchor -n "__fish_anchor_using_subcommand new" -s s -l solidity -d 'Use Solidity instead of Rust'
...
complete -c anchor -n "__fish_anchor_using_subcommand publish" -s e -l env -d 'Environment variables to pass into the docker container' -r
complete -c anchor -n "__fish_anchor_using_subcommand publish" -l arch -d 'Architecture to use when building the program' -r -f -a "{bpf\t'',sbf\t''}"
complete -c anchor -n "__fish_anchor_using_subcommand publish" -l provider.cluster -d 'Cluster override' -r
complete -c anchor -n "__fish_anchor_using_subcommand publish" -l provider.wallet -d 'Wallet override' -r
complete -c anchor -n "__fish_anchor_using_subcommand publish" -l skip-build -d 'Flag to skip building the program in the workspace, use this to save time when publishing the program'
complete -c anchor -n "__fish_anchor_using_subcommand publish" -s h -l help -d 'Print help'
...
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "init" -d 'Initializes a workspace'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "build" -d 'Builds the workspace'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "expand" -d 'Expands macros (wrapper around cargo expand)'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "verify" -d 'Verifies the on-chain bytecode matches the locally compiled artifact. Run this command inside a program subdirectory, i.e., in the dir containing the program\'s Cargo.toml'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "test" -d 'Runs integration tests'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "new" -d 'Creates a new program'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "idl" -d 'Commands for interacting with interface definitions'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "clean" -d 'Remove all artifacts from the generated directories except program keypairs'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "deploy" -d 'Deploys each program in the workspace'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "migrate" -d 'Runs the deploy migration script'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "upgrade" -d 'Deploys, initializes an IDL, and migrates all in one command. Upgrades a single program. The configured wallet must be the upgrade authority'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "cluster" -d 'Cluster commands'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "shell" -d 'Starts a node shell with an Anchor client setup according to the local config'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "run" -d 'Runs the script defined by the current workspace\'s Anchor.toml'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "login" -d 'Saves an api token from the registry locally'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "publish" -d 'Publishes a verified build to the Anchor registry'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "keys" -d 'Program keypair commands'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "localnet" -d 'Localnet commands'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "account" -d 'Fetch and deserialize an account using the IDL provided'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "completions" -d 'Generates shell completions'
complete -c anchor -n "__fish_anchor_using_subcommand help; and not __fish_seen_subcommand_from init build expand verify test new idl clean deploy migrate upgrade cluster shell run login publish keys localnet account completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
